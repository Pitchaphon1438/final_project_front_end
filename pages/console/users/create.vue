    ...
    <template #default>
      <form>
        <div class="form-group mb-6">
          ...
          <InputText placeholder="Frist Name" label="Frist Name" v-model="uss.createForm.FirstName" :errors="formError" errorKey="FristName"/>
         
          <InputText placeholder="Last Name" label="Last Name" v-model="uss.createForm.LastName" :errors="formError" errorKey="LastName"/>
          
          <InputText placeholder="PersonalID" label="PersonalID" v-model="uss.createForm.PersonalID" :errors="formError" errorKey="PersonalID"/>
          <a>User Types</a>
          <br>
        ...
        <ButtonPrimary @click="createUser">Submit</ButtonPrimary>
...
async function createUser(){
  let result = await uss.createUser()
